...
public class DC implements Initializable {
   ...
   private WebEngine webengine;
	...
	public void finalmethod()	
	{
		...
		Result.setLayoutX(1000); Result.setLayoutY(30);
...
String x;
		...
		rollno.setLayoutX(250); rollno.setLayoutY(30);
		DV.setLayoutX(300); DV.setLayoutY(30);
		result.setLayoutX(450); result.setLayoutY(30);
		...
		((Group) sc.getRoot()).getChildren().addAll(contentArea,vbox, editContent, listOfBooks, browse, filePath,result,DV,rollno,Result);
...
//			
			...
			root.getChildren().addAll(htmlEditor, showHTMLButton,result,DV,rollno,Result);
			scene.setRoot(root);
